...
//set collider for mainCyclist
  mainCyclist.setCollider("circle",mainCyclist.offSetX ,        mainCyclist.offSetY, 600);
...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    textSize(20);
    fill(255);
    text("Press GAME OVER to restart",570,200)  
  ...
  if (distance === 5500){
    textSize(40);
    fill(255);
    text("You have completed the race! ",570,200) 
  }
